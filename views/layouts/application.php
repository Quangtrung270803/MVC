...
<body>
    <header id='header'>
        ...
        <div class="header-detail">
            <p>hoa nhon, hoa vang, da nang Việt Nam<br>
    ...
    <nav class="navbar navbar-default" role="navigation" id="nav">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <li class="dropdown menu-name">
                        ...
                        <ul class="dropdown-menu">
							...
							for ($i=0; $i < count($data); $i++) { 
								...
								?>
                            <li><a href="product/List/<?php echo $shortname ?>"><?php echo $data[$i]['tendm'] ?>
                                    (<?php echo $data[$i]['xuatsu'] ?>)</a></li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                <div style="cursor: pointer;"><a href="client/viewcart" style="color: yellow"><i
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4" id="contact">
                    <h3>Contact</h3>
                    <i class="glyphicon glyphicon-map-marker"></i><span> Hoa Vang, Da Nang</span><br>
                    <i class="glyphicon glyphicon-earphone"></i><span> 0905 499 599</span><br>
                    <i class="glyphicon glyphicon-envelope"></i><span> dangconglong@gmail.com</span><br>
                    <h4 style="line-height: 26px">Nhận email thông báo của chúng tôi khi có sản phẩm mới hay giảm giá:
                    </h4>
                ...
                <div class="col-lg-12" id="copyright-txt">
                    <b>All right reverse, &#169; copyright dangconglong</b>
                </div>
            </div>
        </div>
    </footer>
